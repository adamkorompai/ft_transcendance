...
urlpatterns = [
    ...
    path('accept_friend_request/', views.accept_friend_request, name='friend_request_accept'),
    path('decline_friend_request/', views.decline_friend_request, name='friend_request_decline'),
]